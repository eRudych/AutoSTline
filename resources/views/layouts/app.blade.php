...
<body>
   ...
   <nav class="my-2 my-md-0 mr-md-3">
            <a class="p-2 "href="#"><i class="fas fa-phone"></i>+38(068)269-25-03 <br> +38(073)227-65-93</a>
    </nav>
    
     <a class="py-2 d-none d-md-inline-block" href="#"><i class="fas fa-envelope"></i>st-line@i.ua</a>
    ...
    <a class="py-2 d-none d-md-inline-block" href="https://t.me/stlinevn" target="_blank"><i class="fas fa-paper-plane"></i></a>
       ...
       <nav class="site-header sticky-top py-1  d-flex flex-row-reverse nav nav-masthead justify-content-right" style="position: fixed; right:10px">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <a  href="/about" class="nav-link active">О нас</a>
                            </li>
                            <li class="nav-item">
                                <a  href="/products" class="nav-link active">Продукция</a>
                            </li>
                            <li class="nav-item">
