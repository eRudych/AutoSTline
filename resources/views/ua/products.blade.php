...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light "style=" background-image:url({{asset('images/fon.jpg')}})">
  <div class="col-md-5 p-lg-5 mx-auto my-5" style=" background-color:#f8fafc">
    <h3 class="display-6 font-weight-normal">Продукція</h3>
    <p class="lead font-weight-normal">якісний і стильний обвіс мінімізує ризики, пов'язані з їздою в інтенсивному міському потоці і за його межами, забезпечує автомобілю необхідний захист, а разом з ним і тривалу експлуатацію</p>
    <a class="btn btn-outline-secondary" href="https://drive.google.com/drive/folders/0B3SULnEGhz8lRmVhS0tvYkhKUTg" target="_blank">Каталог нашої продукції</a>
  </div>
...
<div class="row">
    <div class="col-md-4">
        ...
        <button class="btn btn-sm btn-outline-secondary" type="button" data-toggle="collapse" data-target=".multi-collapse1" aria-expanded="false" aria-controls="multiCollapseExample1 multiCollapseExample2 multiCollapseExample3">переглянути  ще більше фото</button>
            <div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <p class="card-text">Захист переднього бамперу</p>
          </div>
        </div>
        <button class="btn btn-sm btn-outline-secondary" type="button" data-toggle="collapse" data-target=".multi-collapse2" aria-expanded="false" aria-controls="multiCollapseExample4">переглянути  ще більше фото</button>
            <div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <p class="card-text">Захист заднього бамперу</p>
          </div>
        </div>
        <button class="btn btn-sm btn-outline-secondary" type="button" data-toggle="collapse" data-target=".multi-collapse3" aria-expanded="false" aria-controls="multiCollapseExample5 multiCollapseExample6">переглянути  ще більше фото</button>
            <div class="row">
...
<div class="row">
    <div class="col-md-4">
        ...
        <button class="btn btn-sm btn-outline-secondary" type="button" data-toggle="collapse" data-target=".multi-collapse4" aria-expanded="false" aria-controls="multiCollapseExample7 multiCollapseExample8 ">переглянути  ще більше фото</button>
            <div class="row">
    ...
    <div class="col-md-4">
        ...
        <button class="btn btn-sm btn-outline-secondary" type="button" data-toggle="collapse" data-target=".multi-collapse5" aria-expanded="false" aria-controls="multiCollapseExample9 multiCollapseExample10">переглянути  ще більше фото</button>
            <div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <p class="card-text">Тримачі фар (люстри)</p>
          </div>
        </div>
        <button class="btn btn-sm btn-outline-secondary" type="button" data-toggle="collapse" data-target=".multi-collapse6" aria-expanded="false" aria-controls="multiCollapseExample11">переглянути  ще більше фото</button>
            <div class="row">
...
<div class="row">
    <div class="col-md-4">
        ...
        <button class="btn btn-sm btn-outline-secondary" type="button" data-toggle="collapse" data-target=".multi-collapse7" aria-expanded="false" aria-controls="multiCollapseExample12 multiCollapseExample13 ">переглянути  ще більше фото</button>
            <div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <p class="card-text">Фури, вантажівки</p>
          </div>
        </div>
        <button class="btn btn-sm btn-outline-secondary" type="button" data-toggle="collapse" data-target=".multi-collapse9" aria-expanded="false" aria-controls="multiCollapseExample16 multiCollapseExample17">переглянути  ще більше фото</button>
            <div class="row">
        ...
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <p class="card-text">Насадки на глушиник</p>
          </div>
        </div>
